...
self.addEventListener('message', function(e) {
  ...
  const {groups, totalPlayers, forRounds, withGroupLeaders, forbiddenPairs, discouragedGroups} = e.data
  // Compute results and send them back to the host page
  geneticSolver(groups, totalPlayers, forRounds, withGroupLeaders, forbiddenPairs, discouragedGroups, (results) => {
